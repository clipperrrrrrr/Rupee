...
In order to support loading of multiple wallets in digitalrupee-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is digitalrupee.cpp.
...
Changes to digitalrupee.cpp
----------------------
digitalrupee.cpp is the entry point into digitalrupee-qt, and as such, will require some minor modifications to provide hooks for
