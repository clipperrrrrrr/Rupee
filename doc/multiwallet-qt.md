...
In order to support loading of multiple wallets in rupees-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is rupees.cpp.
...
Changes to rupees.cpp
----------------------
rupees.cpp is the entry point into rupees-qt, and as such, will require some minor modifications to provide hooks for
