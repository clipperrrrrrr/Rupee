...
RESOURCES += src/qt/rupees.qrc src/qt/rupees_locale.qrc

TRANSLATIONS += src/qt/locale/rupees_bg.ts \
                src/qt/locale/rupees_de.ts \
                src/qt/locale/rupees_en.ts \
                src/qt/locale/rupees_es.ts \
                src/qt/locale/rupees_fi.ts \
                src/qt/locale/rupees_fr.ts \
                src/qt/locale/rupees_it.ts \
                src/qt/locale/rupees_ja.ts \
                src/qt/locale/rupees_pl.ts \
                src/qt/locale/rupees_pt.ts \
                src/qt/locale/rupees_ru.ts \
                src/qt/locale/rupees_sk.ts \
                src/qt/locale/rupees_sv.ts \
                src/qt/locale/rupees_vi.ts \
                src/qt/locale/rupees_zh_CN.ts \
                src/qt/locale/rupees_zh_TW.ts
