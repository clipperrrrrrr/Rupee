...
DigitalRupee-Project/DigitalRupee repository.
...
Setup
---------
Configuring the github-merge tool for the DigitalRupee repository is done in the following way:

    git config githubmerge.repository DigitalRupee-Project/DigitalRupee
...
A script to optimize png files in the DigitalRupee
...
If there are 'unsupported' symbols, the return value will be 1 a list like this will be printed:
    ...
    .../64/test_digitalrupee: symbol memcpy from unsupported version GLIBC_2.14
    .../64/test_digitalrupee: symbol __fdelt_chk from unsupported version GLIBC_2.15
    .../64/test_digitalrupee: symbol std::out_of_range::~out_of_range() from unsupported version GLIBCXX_3.4.15
    .../64/test_digitalrupee: symbol _ZNSt8__detail15_List_nod from unsupported version GLIBCXX_3.4.15
