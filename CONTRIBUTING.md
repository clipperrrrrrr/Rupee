Contributing to Rupees Core
============================

The Rupees Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Rupees Core project, and is not to be
confused with overall Rupees Network Protocol consensus changes.

Whether a pull request is merged into Rupees Core rests with the project merge
...
Patches that change Rupees consensus rules are considerably more involved than
...
Where a patch set proposes to change the Rupees consensus, it must have been
...
The project leader is the release manager for each Rupees Core release.
