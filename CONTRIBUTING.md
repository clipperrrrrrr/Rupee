Contributing to DigitalRupee Core
============================

The DigitalRupee Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DigitalRupee Core project, and is not to be
confused with overall DigitalRupee Network Protocol consensus changes.

Whether a pull request is merged into DigitalRupee Core rests with the project merge
...
Patches that change DigitalRupee consensus rules are considerably more involved than
...
Where a patch set proposes to change the DigitalRupee consensus, it must have been
...
The project leader is the release manager for each DigitalRupee Core release.
