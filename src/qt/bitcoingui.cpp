                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DigitalRupee Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DigitalRupee address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DigitalRupee Core"), this);
    aboutAction->setStatusTip(tr("Show information about DigitalRupee Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DigitalRupee"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DigitalRupee addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DigitalRupee addresses"));
    ...
    openAction->setStatusTip(tr("Open a DigitalRupee: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DigitalRupee Core help message to get a list with possible DigitalRupee command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DigitalRupee Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DigitalRupee network", "", count));
}
...
{
    QString strTitle = tr("DigitalRupee Core"); // default title
