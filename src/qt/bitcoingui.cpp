                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Rupees Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Rupees address"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Rupees Core"), this);
    aboutAction->setStatusTip(tr("Show information about Rupees Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Rupees"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Rupees addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Rupees addresses"));
    ...
    openAction->setStatusTip(tr("Open a Rupees: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Rupees Core help message to get a list with possible Rupees command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Rupees Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Rupees network", "", count));
}
...
{
    QString strTitle = tr("Rupees Core"); // default title
