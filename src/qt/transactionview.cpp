 ...
 */
    ...
    typeWidget->addItem(tr("Received Phr from zRs"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zRs"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zRs));
