...
/** Utility functions used by the DigitalRupee Qt UI.
 */
namespace GUIUtil
{
...
// Render DigitalRupee addresses in monospace font
...
// Parse "digitalrupee:" URI into recipient object, return true on successful parsing
