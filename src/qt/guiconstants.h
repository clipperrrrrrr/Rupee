...
/* DigitalRupee GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DigitalRupee"
#define QAPP_ORG_DOMAIN "digitalrupee.org"
#define QAPP_APP_NAME_DEFAULT "DigitalRupee-Qt"
#define QAPP_APP_NAME_TESTNET "DigitalRupee-Qt-testnet"
