...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total rupees balance of the wallet (excluding zerocoins)\n"
            ...
            "  \"zRSsupply\" :\n"
            "  {\n"
            "     \"1\" : n,            (numeric) supply of 1 zRS denomination\n"
            "     \"5\" : n,            (numeric) supply of 5 zRS denomination\n"
            "     \"10\" : n,           (numeric) supply of 10 zRS denomination\n"
            "     \"50\" : n,           (numeric) supply of 50 zRS denomination\n"
            "     \"100\" : n,          (numeric) supply of 100 zRS denomination\n"
            "     \"500\" : n,          (numeric) supply of 500 zRS denomination\n"
            "     \"1000\" : n,         (numeric) supply of 1000 zRS denomination\n"
            "     \"5000\" : n,         (numeric) supply of 5000 zRS denomination\n"
            "     \"total\" : n,        (numeric) The total supply of all zRS denominations\n"
            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in rupees/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in rupees/kb\n"
    ...
    UniValue zrsObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zrsObj.push_back(Pair(to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zrsObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
    obj.push_back(Pair("zRSsupply", zrsObj));
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2) {
        string msg = "createmultisig nrequired [\"key\",...]\n"
                     ...
                     "2. \"keys\"       (string, required) A json array of keys which are rupees addresses or hex-encoded public keys\n"
                     "     [\n"
                     "       \"key\"    (string) rupees address or hex-encoded public key\n"
                     "       ,...\n"
                     "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"rupeesaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"rupeesaddress\"  (string, required) The rupees address to use for the signature.\n"
