...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemarupeesGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemarupeesGrant grantOutbound;
