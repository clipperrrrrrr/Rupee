...
bool OpenNetworkConnection(const CAddress& addrConnect, CSemadigitalrupeeGrant* grantOutbound = NULL, const char* strDest = NULL, bool fOneShot = false);
...
public:
    ...
    CSemadigitalrupeeGrant grantOutbound;
